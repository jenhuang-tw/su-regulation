...
import { m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, p as sanitizeStatusCode, q as getContext, $ as $fetch, r as createHooks, v as executeAsync, f as createError$1, x as toRouteMatcher, y as createRouter$1, z as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BSJDWuR0.mjs')
  },
  {
    name: "regulation-id-embed",
    path: "/regulation/:id()/embed",
    component: () => import('./index-CimvQe3F.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CzOnqJPT.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C3vY7RYA.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useRoute as d, entry$1 as default, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
